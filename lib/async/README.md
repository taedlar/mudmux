...
- Synchronization primitives are provided by `sync.cpp`/`sync.h` as a C-compatible wrapper over C++ primitives.

The legacy C-based `async_worker` abstraction is no longer used.
